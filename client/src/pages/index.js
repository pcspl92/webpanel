...
<div className='toppart'> 
  ...
  <div className='agentdetails'>
    agent display name
    <div style={{fontSize:"2vh",fontWeight:"bold"}}>Lang &nbsp; &nbsp;  logout </div>
  </div>
  </div>  
...
<div className="headings"> + User Management
</div>

<div className="headings">+ License Management
</div>

<div className="headings" onClick={dropdownagent}>+ Sub-Agent Management
...
<div className="headings">+ Personal Center
</div>
